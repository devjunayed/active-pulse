...
const AllSubscribers = () => {
    ...
    const { data: newsLetter = [],  isPending, isFetching } = useQuery({
        queryKey: [],
        queryFn: async () => {
    ...
    return (
        <div>
            {
                isPending || isFetching ? <div className="h-screen flex justify-center items-center"><span className="loading"></span></div> :
                    <div>
