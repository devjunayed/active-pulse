...
const AllTrainers = () => {
    ...
    const { data: trainers = [], isFetching, isPending } = useTrainers();


    return (
        <div>
            {
                isPending || isFetching ? <div className='flex h-screen justify-center items-center'><span className="loading"></span></div> :<div>
